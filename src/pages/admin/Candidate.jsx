...
function CandidatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    await uploadBytes(imageRef, inputImage, metadata)
      .then(() => {
        ...
        <form>
          <div className="block mb-3 md:flex md:mb-9">
            <div className="mb-3 md:mb-0">
              <label className="uppercase text-gray-400 font-bold block">
                Nama Ketua
              </label>
              <input
                ref={nama_ketua}
          ...
          <div className="mb-3 md:mb-8">
            ...
            <textarea
              ref={visi}
              className="border border-gray-300 focus:outline-none bg-gray-200 text-gray-400 focus:border-sky-500 md:w-60 focus:bg-white focus:text-black px-3 py-2"
            />
          </div>
          <div className="mb-3 md:mb-4">
            <label className="uppercase text-gray-400 font-bold block">
